      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="main-content">
            <form action="${pageContext.request.contextPath }/Add" method="post" enctype="multipart/form-data" id="addForm">
                    ...
                    <div class="image-container2">
                            ...
                            <input  type="file"  id="input-image3" style="display: none;" name="file">
                            <label id="Tpic" class="selected_pic" for="input-image3" style="width: 400px; height: 400px;">
                            
                                <img  style='width:auto;height:auto; max-width: 350px; max-height: 350px; object-fit: contain;' id="preview-image3" src="shopImages/addIMG.png">
                            </label>
                        </div>
                        <br>
                        <br>
                        <h6>상품명: <input type="text" name="name"></h6><br><br>
                    	<h6>수량 : <input type="text" name="quantity"></h6><br><br>
                    	<h6>가격 : <input type="text" name="price"></h6><br><br>
                    	<h6>카테고리: <select name="category" form="addForm">
